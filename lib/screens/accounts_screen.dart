...
class _AccountsScreenState extends State<AccountsScreen> {
  ...
  Future<void> _login() async {
    ...
    if (user != null) widget.onLoginSuccess?.call();
  }
  ...
  Future<void> _register() async {
    ...
    await _auth.register(email, pass, name: name.isNotEmpty ? name : null);
    final user = await _auth.login(email, pass);
    setState(() { _loading = false; _user = user; });
    if (user != null) widget.onLoginSuccess?.call();
  }
 ...
 Widget build(BuildContext context) {
  ...
  Widget _buildLogin() {
    return Column(
      ...
      children: [
        Text(_isLogin ? 'Sign in to your account' : 'Create an account', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
  ...
  Widget _buildAccountDetails() {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Welcome, $name', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
        SizedBox(height: 8),
        Text('Email: $email'),
        SizedBox(height: 20),
        ...
        Row(
          ...
          children: [
            ...
            Switch(value: _notificationsEnabled, onChanged: _toggleNotifications),
          ],
        ),
        SizedBox(height: 8),
        ...
        ElevatedButton(
          onPressed: _notificationsEnabled ? () async {
            ...
            if (picked != null) {
              ...
              await NotificationService.initialize();
              await NotificationService.scheduleDailyNotification(hour: picked.hour, minute: picked.minute, title: 'Plan Reminder', body: 'Review your itinerary for today!');
            }
          } : null,
